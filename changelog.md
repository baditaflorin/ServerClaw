...
- adds repowise semantic code search — local corpus builder, Ollama nomic-embed-text embeddings in Qdrant, FastAPI /search endpoint with language and document_kind filters; Ansible role repowise_runtime deploys on docker-runtime
