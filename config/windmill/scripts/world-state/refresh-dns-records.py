...
def main(
    ...
    return run_worker("dns_records", repo_path=repo_path, dsn=dsn, publish_nats=publish_nats)


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Refresh the world-state dns_records surface.")
