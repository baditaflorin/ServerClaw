...
Outputs: a mounted PBS datastore, a local PBS API token file on the controller, a managed seed snapshot store under `/var/lib/lv3/seed-data-snapshots`, and a running PBS service on `backup`.
