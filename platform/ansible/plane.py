    ...
    def _request(
        ...
        *,
        ...
        retry_policy = RetryPolicy(
            ...
            max_delay_s=self.rate_limit_backoff_seconds * (2**self.max_rate_limit_retries),
            multiplier=2.0,
            jitter=False,
            transient_max=0,
        )

        def perform_request() -> tuple[int, Any]:
            try:
        ...
        try:
            ...
            raise PlaneError(f"{method} {path} exhausted retry policy: {exc}") from exc
