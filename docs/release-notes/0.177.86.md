...
## Platform Impact
- no live platform version bump yet; the canonical platform baseline remains 0.130.58 until the exact-main Windmill replay records the new ADR 0251 stage-smoke and promotion receipts
