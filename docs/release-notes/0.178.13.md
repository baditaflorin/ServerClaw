...
## Summary
- hardened OpenBao TLS cert renewal: extended cert lifetime from 24h to 72h (66h missed-renewal tolerance), added openbao to cert-expiry monitoring, added 4h critical alert for imminent expiry
