...
- ADR 0375: Certificate validation and concordance enforcement — automated SSL checking for all edge-published domains, pre-push gate integration, Uptime Kuma monitors, and fix playbook for NGINX edge certificate hostname mismatches (ci.example.com, bi.example.com, grist.example.com, paperless.example.com, annotate.example.com, ntfy.example.com).
