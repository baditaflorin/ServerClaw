...
- refreshed ADR 0070 release metadata, stack observations, and the live-apply receipt for the verified platform-context deployment now running on `docker-runtime`
