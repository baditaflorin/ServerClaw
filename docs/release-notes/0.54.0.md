...
- applied ADR 0060 live by converging a private Open WebUI runtime on `docker-runtime` and publishing it through the Proxmox host Tailscale proxy on port `8008`
