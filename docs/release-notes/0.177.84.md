...
## Summary
- implemented ADR 0254 by publishing the first dedicated ServerClaw chat surface on chat.example.com with Keycloak-backed sign-in and repo-managed Ollama plus SearXNG integrations
...
- introduces the first dedicated ServerClaw chat surface on chat.example.com as integrated mainline truth, with the synchronized latest-main replay and canonical platform-version receipt completed in the same workstream
