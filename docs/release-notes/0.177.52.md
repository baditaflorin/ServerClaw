...
- implemented ADR 0226 by installing the repo-managed systemd service, timer, and path baseline for host-resident control loops on proxmox-host and verifying both manual and path-triggered reconcile passes
