...
- langfuse_runtime: set langfuse_disable_signup=false for automatic Keycloak SSO user provisioning; add extra_hosts hairpin NAT fix for sso.example.com in both langfuse-web and langfuse-worker
