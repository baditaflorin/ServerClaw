...
## Summary
- Implemented ADR 0145 with a repo-managed Ollama runtime on `docker-runtime`, a pinned `ollama/ollama:0.18.2` image, a declarative startup model catalog, and health/dependency/catalog wiring for the new private inference service.
