...
- recorded the verified ADR 0093 live rollout at `ops.lv3.org`, updated the ADR/workstream status to `live_applied`, and captured the live-apply receipt in the canonical platform state
