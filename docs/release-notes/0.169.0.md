...
## Summary
- publish the repo-generated Homepage dashboard at `https://home.example.com` through the shared authenticated edge, with generated service and bookmark catalogs served from `docker-runtime`
