...
## Platform Impact
- promotes the platform to `0.130.34`; the 2026-03-28 governed `rag-context` replay from the `0.177.26` main-candidate commit verified healthy semantic vector retrieval on `docker-runtime`
