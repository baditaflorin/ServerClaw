...
- [docs/runbooks/agent-tool-registry.md](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/docs/runbooks/agent-tool-registry.md): governed agent-tool discovery, MCP export, bounded controller-local dispatch, and audit behavior
...
- [scripts/agent_tool_registry.py](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/scripts/agent_tool_registry.py): validates the governed tool registry, exports MCP-compatible tool definitions, dispatches bounded tool calls, and emits controller-local audit events
...
- [config/agent-tool-registry.json](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/config/agent-tool-registry.json): canonical machine-readable registry of governed observe, report, execute, and approve tools for agents and operators
