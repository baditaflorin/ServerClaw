...
- Status: live_applied
- Included In Repo Version: `0.178.5`
...
- The exact-main validation base stayed at `0.178.4`, and the first repository release that includes this repo-only closeout is `0.178.5`.
