...
- The canonical release and live state are now advanced on `main` in repo version `0.177.5` and platform version `0.130.26`, with the verified replay recorded in `receipts/live-applies/2026-03-27-adr-0101-certificate-lifecycle-main-live-apply.json`.
