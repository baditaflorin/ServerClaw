...
- ADR: [ADR 0055](/Users/live/Documents/GITHUB_PROJECTS/proxmox-host_server/docs/adr/0055-portainer-for-read-mostly-docker-runtime-operations.md)
- Title: Visual Docker runtime inspection with bounded control actions
- Status: live_applied
- Branch: `codex/adr-0055-portainer-operations`
- Worktree: `../proxmox-host_server-portainer-operations`
- Owner: codex
- Depends On: `adr-0023-docker-runtime`, `adr-0025-docker-compose-stacks`, `adr-0048-command-catalog`
- Conflicts With: none
- Shared Surfaces: `docker-runtime`, Compose stacks, container logs, runtime controls
...
- a private Docker runtime console on `docker-runtime`
...
- Portainer surfaced pre-existing unmanaged containers on docker-runtime during rollout; leave those visible for inspection, but do not normalize them into repo truth without a separate ADR or integration step
