...
- Status: blocked
- Included In Repo Version: latest realistic `origin/main` replay base `0.177.135`
...
- Latest origin/main Base: `0.177.135` at `cbb0c99f3f69c3ab2bb7658daf443c45df9ea49b`
...
- The branch is now freshly rebased onto latest realistic `origin/main` `cbb0c99f3f69c3ab2bb7658daf443c45df9ea49b` at repository version `0.177.135`.
...
- The rebased repo validation picture is now current on `0.177.134`. `make remote-validate` passes via `receipts/live-applies/evidence/2026-04-01-adr-0281-mainline-remote-validate-r3-0.177.134.txt`, `make check-build-server` passes via `receipts/live-applies/evidence/2026-04-01-adr-0281-mainline-check-build-server-r1-0.177.134.txt`, and both `make validate` plus `make pre-push-gate` are now reduced to the same protected generated-docs blocker: canonical truth wants to rewrite the top-level `README.md`; see `receipts/live-applies/evidence/2026-04-01-adr-0281-mainline-validate-r2-0.177.134.txt` and `receipts/live-applies/evidence/2026-04-01-adr-0281-mainline-pre-push-gate-r1-0.177.134.txt`.
...
- Fresh read-only public checks on 2026-04-02 still show the live edge is drifted: `errors.lv3.org` resolves to `65.108.75.123` but serves certificate `CN=nginx.lv3.org` and `308` redirects `/health/` to `https://nginx.lv3.org/health/`; see `receipts/live-applies/evidence/2026-04-02-adr-0281-current-public-surface-r1-0.177.134.txt` and `receipts/live-applies/evidence/2026-04-02-adr-0281-current-public-cert-r1-0.177.134.txt`.
