...
- The integrated `main` release is `0.177.47`, and receipt `2026-03-28-adr-0197-dify-mainline-live-apply` supersedes the earlier branch-local brownout receipt as the canonical merged-main evidence for ADR 0197.
