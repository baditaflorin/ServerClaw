...
- the 2026-03-26 production replay from the current `main` lineage reconverged `docker-runtime-lv3`, and the gateway now serves the ADR 0163 runtime bundle live in platform version `0.130.15`
