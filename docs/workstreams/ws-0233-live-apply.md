...
- merged to `main` in repository version `0.177.54`
...
- updated `VERSION`, `changelog.md`, `RELEASE.md`, `docs/release-notes/0.177.54.md`, `README.md`, `versions/stack.yaml`, `build/platform-manifest.json`, and the ADR metadata only during the final mainline integration step
