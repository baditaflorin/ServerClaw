...
- Updating that lookup to `playbook_dir ~ '/../../scripts/docker_publication_assurance.py'` in [`collections/ansible_collections/lv3/platform/roles/docker_runtime/tasks/main.yml`](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.worktrees/ws-0295-live-apply-r2/collections/ansible_collections/lv3/platform/roles/docker_runtime/tasks/main.yml) and aligning [`tests/test_docker_runtime_role.py`](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.worktrees/ws-0295-live-apply-r2/tests/test_docker_runtime_role.py) restored the latest-main automation path without touching protected release-truth files.
- `ALLOW_IN_PLACE_MUTATION=true make live-apply-service service=build-artifact-cache env=production EXTRA_ARGS='-e bypass_promotion=true'` then succeeded again from the rebased latest-main worktree rooted on `9ce18e9c35cd4c8e97411c92e6dada5c3a2c3dd7` with final recap `docker-build-lv3 : ok=119 changed=4 unreachable=0 failed=0 skipped=11 rescued=0 ignored=0`.
...
- The repaired exact-main rerun kept the cache plane healthy while the shared wrapper reasserted broader Docker-runtime compatibility on `docker-build-lv3`, including the live nftables forward accepts for `172.16.0.0/12` and `192.168.0.0/16`, updated public-edge hostname pinning, and a refreshed BuildKit socket permission.
