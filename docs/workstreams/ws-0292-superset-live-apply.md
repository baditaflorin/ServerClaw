...
- `docs/runbooks/docker-runtime-disk-pressure.md` now records the safe cache and journal cleanup path that restored MinIO and Restic on `docker-runtime-lv3` without hiding the shared-host dependency
