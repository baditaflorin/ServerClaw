...
- None. The protected integration files were updated during the merged-main `0.177.39` release step, and the canonical live platform version remained `0.130.38` after the verified replay.
