...
- ADR: [ADR 0198](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/docs/adr/0198-qdrant-vector-search-semantic-rag.md)
...
- A full repo-grounded rebuild still belongs to an explicit maintenance action because the expanded mirrored corpus exceeds the safe synchronous Ollama budget on `docker-runtime-lv3`.
