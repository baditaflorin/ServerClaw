...
- Status: ready
- Branch: `codex/adr-0084-packer-pipeline`
- Worktree: `../proxmox_florin_server-packer-pipeline`
- Owner: codex
...
- write `variables/common.pkrvars.hcl` and `variables/build-server.pkrvars.hcl`
...
- `packer/variables/common.pkrvars.hcl`
