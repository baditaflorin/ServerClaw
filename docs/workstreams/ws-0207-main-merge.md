...
- `VERSION`, `RELEASE.md`, `docs/release-notes/0.177.40.md`, `README.md`, `versions/stack.yaml`, and `workstreams.yaml` now record the merged ADR 0207 truth before the final push to `origin/main`
