...
- `make remote-validate` passed from the merged `0.177.38` worktree and completed the build-server validation manifest end to end
...
- `VERSION`, `RELEASE.md`, `docs/release-notes/0.177.38.md`, `README.md`, `versions/stack.yaml`, and `workstreams.yaml` now record the merged ADR 0207 truth before the final push to `origin/main`
