...
- Status: merged
- Included In Repo Version: 0.177.34
- Platform Version Observed During Merge: 0.130.36
- Release Date: 2026-03-28
- Branch: `codex/ws-0206-main-merge`
- Worktree: `/Users/live/Documents/GITHUB_PROJECTS/proxmox-host_server/.worktrees/ws-0206-main-merge`
- Owner: codex
...
- rebase after `origin/main` advanced with the ADR 0224 `0.177.33` release, then cut the follow-on `0.177.34` release for ADR 0206 without changing the live platform version
...
- ADR 0206 is now attributed to repo version `0.177.34` on `main`
