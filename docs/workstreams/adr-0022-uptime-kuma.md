# Workstream ADR 0022: Uptime Kuma On The Docker Runtime VM

- ADR: [ADR 0022](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/docs/adr/0022-uptime-kuma-on-the-docker-runtime-vm.md)
...
- changing protected integration files such as `VERSION`, `changelog.md`, `README.md`, or `versions/stack.yaml` on this branch
...
- `docs/adr/0022-uptime-kuma-on-the-docker-runtime-vm.md`
- `workstreams.yaml`
...
- no speculative `VERSION`, `README.md`, `changelog.md`, or `versions/stack.yaml` changes are introduced on the branch
