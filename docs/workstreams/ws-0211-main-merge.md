...
- After absorbing the concurrent ADR 0210 `0.177.35` mainline integration, ADR 0211 was recut as release `0.177.36`, updating the protected integration files and marking `ws-0211-live-apply` as included in that repo release.
...
- The branch-local receipt remains preserved for history, while `receipts/live-applies/2026-03-28-adr-0211-shared-policy-packs-and-rule-registries-mainline-live-apply.json` is the canonical evidence for the integrated `0.177.36` mainline state.
