...
Managed guests now declare `template_key` in [inventory/host_vars/proxmox_florin.yml](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server-adr-0084/inventory/host_vars/proxmox_florin.yml), and [roles/proxmox_guests/tasks/main.yml](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server-adr-0084/roles/proxmox_guests/tasks/main.yml) clones from the corresponding `proxmox_vm_templates` entry instead of creating a Debian cloud template inline.
