...
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/vaultwarden/database-password.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/vaultwarden/admin-token.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/vaultwarden/admin-token-argon2.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/vaultwarden/bootstrap.json`
...
1. Open `https://vault.lv3.org`.
2. Complete the invited-account registration flow for `ops@lv3.org`.
