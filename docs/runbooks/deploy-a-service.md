...
5. Apply the live automation from `main` with the bounded workflow for that service. The live-apply target now runs the ADR 0179 redundancy preflight before Ansible starts.
