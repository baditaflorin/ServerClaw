...
- `mautrix-discord` and `mautrix-whatsapp` bridge deployment on `docker-runtime-lv3`
...
- PostgreSQL database `mautrix_discord` on `postgres-lv3`
- PostgreSQL login role `mautrix_discord` on `postgres-lv3`
- PostgreSQL database `mautrix_whatsapp` on `postgres-lv3`
- PostgreSQL login role `mautrix_whatsapp` on `postgres-lv3`
- Matrix Synapse runtime under `/opt/matrix-synapse` on `docker-runtime-lv3`
- `mautrix-discord` bridge runtime under `/opt/matrix-synapse/mautrix-discord` on `docker-runtime-lv3`
- `mautrix-whatsapp` bridge runtime under `/opt/matrix-synapse/mautrix-whatsapp` on `docker-runtime-lv3`
...
- repo-managed bridge bot accounts `@discordbot:matrix.lv3.org` and `@whatsappbot:matrix.lv3.org`
...
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-discord-database-password.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-whatsapp-database-password.txt`
...
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-discord-as-token.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-discord-hs-token.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-discord-provisioning-shared-secret.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-discord-avatar-proxy-key.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-whatsapp-as-token.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-whatsapp-hs-token.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-whatsapp-provisioning-shared-secret.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-whatsapp-public-media-signing-key.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/mautrix-whatsapp-encryption-pickle-key.txt`
...
6. `python3 scripts/matrix_bridge_smoke.py --base-url https://matrix.lv3.org --username ops --password-file /Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/matrix-synapse/ops-password.txt --bot-user-id @discordbot:matrix.lv3.org --bot-user-id @whatsappbot:matrix.lv3.org --timeout-seconds 90`
