...
- the core engine runs from [`scripts/incident_triage.py`](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.worktrees/adr-0114/scripts/incident_triage.py)
- the Windmill wrapper lives in [`config/windmill/scripts/run-triage.py`](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.worktrees/adr-0114/config/windmill/scripts/run-triage.py)
- weekly calibration lives in [`config/windmill/scripts/calibrate-triage-rules.py`](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.worktrees/adr-0114/config/windmill/scripts/calibrate-triage-rules.py)
...
- only check types listed in [`config/triage-auto-check-allowlist.yaml`](/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.worktrees/adr-0114/config/triage-auto-check-allowlist.yaml) may auto-run
