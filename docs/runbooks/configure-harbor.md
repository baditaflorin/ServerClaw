...
This runbook converges the Harbor registry from ADR 0201 and validates the live `registry.lv3.org` cutover.
...
- DNS publication if the record is still absent: `HETZNER_DNS_API_TOKEN=... make provision-subdomain FQDN=registry.lv3.org`
...
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/harbor/admin-password.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/harbor/database-password.txt`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/harbor/check-runner-robot.json`
- `/Users/live/Documents/GITHUB_PROJECTS/proxmox_florin_server/.local/keycloak/harbor-client-secret.txt`
