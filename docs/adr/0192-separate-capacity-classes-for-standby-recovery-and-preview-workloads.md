...
- The live verification on 2026-03-27 used the branch commit `40df2935` against the real platform state. Protected integration files still wait for merge to `main`.
