...
- The repo now deploys Open WebUI through [playbooks/open-webui.yml](/Users/live/Documents/GITHUB_PROJECTS/proxmox-host_server/playbooks/open-webui.yml) and [roles/open_webui_runtime](/Users/live/Documents/GITHUB_PROJECTS/proxmox-host_server/roles/open_webui_runtime) on `docker-runtime`.
- [config/workflow-catalog.json](/Users/live/Documents/GITHUB_PROJECTS/proxmox-host_server/config/workflow-catalog.json), [config/command-catalog.json](/Users/live/Documents/GITHUB_PROJECTS/proxmox-host_server/config/command-catalog.json), and [config/control-plane-lanes.json](/Users/live/Documents/GITHUB_PROJECTS/proxmox-host_server/config/control-plane-lanes.json) now treat Open WebUI as a named private operator surface with an explicit converge workflow and approval contract.
