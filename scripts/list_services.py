...
Cross-deployment diff:
  python3 scripts/list_services.py --diff example.com 0fork.com  # compare two
  python3 scripts/list_services.py --diff example.com 0fork.com --format json
...
def build_parser() -> argparse.ArgumentParser:
    ...
    mode.add_argument(
        ...
        nargs=2,
        metavar=("LEFT", "RIGHT"),
        help="Show what differs between two deployments (e.g. --diff example.com 0fork.com).",
    )
    parser.add_argument(
        "--deployment",
        metavar="DOMAIN",
