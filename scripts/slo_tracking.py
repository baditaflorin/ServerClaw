...
K6_RECEIPTS_DIR = repo_path("receipts", "k6")
...
def build_slo_status_entries(
    *,
    ...
    repo_root = catalog_path.parents[1]
    latest_k6_receipts = load_latest_k6_receipts(repo_root=repo_root, receipts_dir=repo_root / "receipts" / "k6")
