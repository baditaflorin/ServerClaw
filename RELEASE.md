...
## Platform Impact
- platform version remains at 0.130.61 until the exact-main ADR 0260 replay is re-verified from release 0.177.93; this release prepares the synchronized Nextcloud recovery hardening on top of the current 0.177.92 / 0.130.61 baseline.
