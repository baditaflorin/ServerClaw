...
.PHONY: syntax-check install-proxmox configure-network configure-ingress configure-tailscale provision-guests harden-access harden-guest-access harden-security provision-api-access
