...
prepare-edge-static-sites: generate-ops-portal generate-changelog-portal docs

deploy-ops-portal:
	$(MAKE) configure-edge-publication

deploy-changelog-portal:
	$(MAKE) configure-edge-publication

deploy-docs-portal:
	$(MAKE) configure-edge-publication

generate-status: generate-status-docs generate-ops-portal generate-changelog-portal docs
...
configure-edge-publication: prepare-edge-static-sites
