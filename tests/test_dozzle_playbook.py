...
PLAYBOOK_PATH = REPO_ROOT / "collections" / "ansible_collections" / "lv3" / "platform" / "playbooks" / "dozzle.yml"
...
def test_dozzle_playbook_converges_proxmox_network_before_runtime() -> None:
    ...
    runtime_play = next(play for play in plays if play["hosts"] == "docker-runtime-lv3:docker-build-lv3:monitoring-lv3")
