...
def test_secret_rotation_leaves_service_healthy(authentik_token: str, integration_config) -> None:
    ...
    result = poll_job(integration_config, authentik_token, job_id, timeout_seconds=180)
